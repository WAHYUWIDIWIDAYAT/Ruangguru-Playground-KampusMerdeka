...
func main() {
	...
	for i := 1; i <= sizeQueue; i++ {
		if i < 5 {
			fmt.Printf("%d  membeli 1kg beras dengan kualitas [SUPER]\n", i)
		}
		if i > 5 && i < 11 {
			fmt.Printf("%d  membeli 1kg beras dengan kualitas [MEDIUM]\n", i)
		}
		if i > 10 && i < 16 {
			fmt.Printf("%d  membeli 1kg beras dengan kualitas [LOW]\n", i)
		}
	}
}
